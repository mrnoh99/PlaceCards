...
- 문서:
  - `CHANGELOG.md` — 어떤 변경이 왜 그렇게 됐는지. **249차(빌드 46, PR #112)
    까지 최신이다.** 가장 믿을 만하다.
  ...
  - `00_다른_계정에서_이어받기.md` — 다른 Apple 계정/다른 사람이 이어받을 때
    바꿔야 하는 식별자. App Group은 entitlements 둘 말고 **Swift 상수까지
    셋**이고, 빠뜨리면 공유가 조용히 죽는다.
  - `00_인수인계_현재상태.md` — PR #43에서 멈췄다. 앱 소개와 금지사항은
    유효하고, "다음에 할 일"은 PR 70개만큼 낡았다.
