...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "개 장소 중 ": " places in this list, only ",
        "개)": ")",
        "개만 가져올 수 있었습니다. 나머지는 목록을 캡처해서 사진으로 추가해주세요.": " could be read. Add the rest by screenshotting the list and importing it as a photo.",
        "게시판 이름": "Board name",
        "공유한 목록": "Shared list",
