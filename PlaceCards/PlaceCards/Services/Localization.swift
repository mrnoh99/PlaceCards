...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "iCloud에 올리기": "Upload to iCloud",
        "지금 올리기": "Upload Now",
        "준비 중…": "Preparing…",
        "개 보드": " boards",
        "iCloud 연결을 먼저 확인해주세요.": "Check the iCloud connection first.",
        "지금 올리기는 이 기기의 게시판과 장소를 본인 iCloud로 복사만 합니다. 내려받지 않으므로 이 기기의 자료는 바뀌지 않으며, 사진은 아직 올라가지 않습니다.": "Upload Now copies only this device’s boards and places to your own iCloud. It does not download anything, so nothing on this device changes, and photos are not uploaded yet.",
        "확인 안 함": "Not checked",
        "확인 중…": "Checking…",
        "연결됨 (": "Connected (",
