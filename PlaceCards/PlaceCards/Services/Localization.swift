...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "사진에 위치 정보가 없어 어디서 찍혔는지 알 수 없습니다. 아이폰 설정에서 카메라의 위치 접근을 켜면 앞으로 찍는 사진부터 기록됩니다.": "The photos carry no location, so there is no way to tell where they were taken. Turn on location access for Camera in iPhone Settings and photos you take from then on will be recorded.",
        "사진에 촬영 날짜가 없습니다.": "The photos carry no capture date.",
        "촬영 날짜와 위치가 함께 있는 사진이 없습니다.": "No photo carries both a capture date and a location.",
