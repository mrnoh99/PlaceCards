...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "다른 필터를 선택해보세요.": "Try choosing a different filter.",
        "다음": "Next",
        "닫기": "Close",
        "데이터": "Data",
        ...
        "오른쪽 위 + 버튼으로 이 게시판에 첫 장소를 추가해보세요.": "Use the + button in the top right to add the first place to this board.",
        "완료": "Done",
        "요일": "Day",
        ...
        "해당하는 장소가 없습니다": "No Matching Places",
        "현장 촬영": "Taken on-site",
