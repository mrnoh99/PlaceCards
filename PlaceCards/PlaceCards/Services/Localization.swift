...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "담기": "Save",
        "사진 앱의 PinSpots 앨범에 이 카드의 사진을 담습니다. 사진 앱에서 고른 사진이었다면 라이브러리에 한 장 더 생깁니다.": "Adds this card's photos to a PinSpots album in Photos. For a photo you originally picked from Photos, this creates one more copy in your library.",
