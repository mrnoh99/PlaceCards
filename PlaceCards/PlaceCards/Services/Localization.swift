...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "담기": "Save",
        "사진 앱의 PinSpots 앨범에 이 카드의 사진을 전부 담습니다. 한 장만 담으려면 사진을 눌러 크게 연 뒤 오른쪽 위 메뉴를 쓰세요. 사진 앱에서 고른 사진이었다면 라이브러리에 한 장 더 생깁니다.": "Adds all of this card's photos to a PinSpots album in Photos. To save just one, tap a photo to open it full screen and use the menu at the top right. For a photo you originally picked from Photos, this creates one more copy in your library.",
        "사진 앱의 PinSpots 앨범에 이 사진 한 장을 담습니다. 사진 앱에서 고른 사진이었다면 라이브러리에 한 장 더 생깁니다.": "Adds this one photo to a PinSpots album in Photos. For a photo you originally picked from Photos, this creates one more copy in your library.",
