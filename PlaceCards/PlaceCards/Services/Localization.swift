...
enum Localization {
    static let englishTranslations: [String: String] = [
        ...
        "사진에서 장소 이름을 읽지 못했습니다. 지도 앱의 장소 화면을 찍은 스크린샷에서 가장 잘 동작합니다. 설정에서 AI 키를 등록하면 인스타그램 게시물 같은 사진에서도 찾을 수 있습니다.": "Couldn't read a place name from the photo. This works best on a screenshot of a map app's place screen. Register an AI key in Settings to also find places in photos like Instagram posts.",
